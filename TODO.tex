...
\todo{\paragraph{STILL TO DISCUSS.}\begin{itemize}
    ...
    \item Consistency: convergence curves must all have the same x-axis (time, step, or epoch). \mdeff{I think epoch would be good.} \mdeff{Steps is better as we don't really have epochs (due to sampling of the sum over pairs).}
