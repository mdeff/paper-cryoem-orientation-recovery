...
\begin{figure}[t]
    \centering
    \includegraphics[width=\textwidth]{images/EuclideanDistance_NonRobust.pdf}
...
\begin{figure}[t!]
    \centering
   \includegraphics[width=\textwidth]{images/siameseNN-schematic.pdf}
...
\begin{figure}[t!]
    ...
    \begin{subfigure}[t]{0.4\textwidth}
        \includegraphics[width=0.98\textwidth]{images/TrainingSiamese_LossAssymetric.pdf}
    ...
    %
    \begin{subfigure}[t]{0.4\textwidth}
        \includegraphics[width=0.98\textwidth]{images/TrainingSiamese_LossSymetric.pdf}
    ...
    %
    \begin{subfigure}[t]{0.4\textwidth}
        \includegraphics[width=0.98\textwidth]{images/TrainingSiamese_PlotAssymetric.pdf}
