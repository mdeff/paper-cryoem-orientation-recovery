...
\begin{figure}
    ...
    \begin{minipage}[b]{0.45\linewidth}
        \begin{subfigure}[b]{\linewidth}
            ...
            %\todo{y-ticks for \texttt{5a1a} as \texttt{5j0n}.}
            \vspace{0.8em}}
...
\begin{figure}[t]
    ...
    \begin{subfigure}[b]{0.31\linewidth}
        ...
        \includegraphics[height=3cm]{figures/5a1a_quartercvg_uniformS2_noise0_FSC_apr_init_customFSC.pdf}
        \caption{}
    \end{subfigure}
    ...
    \caption{%
        ...
        %\banjac{Discuss updated \texttt{5a1a}} 
        \lau{Suggestions: 1. remove artifact below b), 2. have (g), (i) and (k) be all displayed at the same size, 3. filter volumes at the resolution indicated by the FSC at 0.5 (commonly done in the field), 4. add short captions. Other comment: I'm a little bit surprised at the FSC in (j), let's discuss this evening.}
