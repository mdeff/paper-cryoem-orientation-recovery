...
\begin{figure}[t]
    ...
    \begin{subfigure}[b]{0.45\linewidth}
        ...
        \includegraphics[height=3cm]{figures/5j0n_fullcvg_uniformS2_noise0_ar_aa.pdf}
    ...
    \begin{subfigure}[b]{0.31\linewidth}
        ...
        \caption{Fourier shell correlation.}%
        %between final reconstruction and initial volume.
    \end{subfigure}
    \hfill
    ...
    \begin{subfigure}[b]{0.45\linewidth}
        ...
        \includegraphics[height=3cm]{figures/5j0n_fullcvg_uniformS2_noise16_ar_aa.pdf}
    ...
    \begin{subfigure}[b]{0.45\linewidth}
        \centering
        \includegraphics[height=3cm]{figures/5a1a_quartercov_uniformS2_noise0_halfInplane_ar_aa.pdf}
...
\begin{figure}[t]
    ...
    \caption{%
        ...
        \mdeff{Shall we show the densities reconstructed from random orientations? If not, we could show our reconstructed densities in Figure 11. The ground-truths are not exactly the ones in Figure 6, but they should be right?}
    }
\end{figure}
