...
To capture only one of four identical projections of \texttt{5a1a}, we restricted directions to $(\theta_2, \theta_1) \in [0, \pi[ \, \times \, [0, \frac{\pi}{2}[$ (\figref{orientation-constraints}) for that protein.
...
Symmetries aren't an issue beyond distance learning: orientations will be recovered over one of the four identical subdomains.
...
\begin{figure}
    ...
    \begin{minipage}[b]{0.45\linewidth}
        \begin{subfigure}[b]{\linewidth}
            ...
            \caption{Loss converged on \texttt{5j0n} (left) and \texttt{5a1a} (right). \todo{y-ticks for \texttt{5a1a} as \texttt{5j0n}.}\vspace{0.8em}}\label{fig:distance-learning:loss}
        \end{subfigure}
        \\ %\vspace{1em}
        \begin{subfigure}[b]{\linewidth}
            \centering
...
\todo{Note that part of this decrease in resolution originates from reconstructing with degraded projections, as the same effect is observed with the reconstruction obtained from true orientations (\figref{5j0n-noise16-reconstruction-true}).}
...
\begin{figure}[t]
    ...
    \caption{%
        ...
        \todo{Same y-ticks for the three blue and red plots.}
        \mdeff{Check $L_\text{DE}$, \eg, it's 0.106 for val in (c) while it's 0.105 in Figure 8a.}
    }
\end{figure}
...
\begin{figure}[t]
    ...
    \vspace{1em}
    \begin{subfigure}[b]{0.23\linewidth}
        %\includegraphics[height=3cm]{figures/5j0n_fullcvg_uniformS2_noise16_gt_noisy.png}
        \caption*{}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.18\linewidth}
    ...
    \begin{subfigure}[b]{0.31\linewidth}
        ...
        \includegraphics[height=3cm]{figures/5j0n_fullcvg_uniformS2_noise16_FSC_apr_init_customFSC.pdf}
        \caption{}
    \end{subfigure}
    ...
    \begin{subfigure}[b]{0.23\linewidth}
        \centering
        \includegraphics[height=3cm]{figures/5a1a_quartercov_uniformS2_noise0_gt.png}
        \caption{}\label{fig:5a1a-noise0-reconstruction-true}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.18\linewidth}
        \centering
        \includegraphics[height=3cm]{figures/5a1a_quartercov_uniformS2_noise0_rand.png}
        \caption{}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.23\linewidth}
    ...
    % \begin{subfigure}[b]{0.23\linewidth}
    %     \centering
    %     %\includegraphics[height=3cm]{figures/5a1a_quartercov_uniformS2_noise0_halfInplane_gt.png}
    %     \caption*{}\label{fig:5a1a-noise0-reconstruction-true}
    % \end{subfigure}
    % \hfill
    % \begin{subfigure}[b]{0.18\linewidth}
    %     \centering
    %     %\includegraphics[height=3cm]{figures/5a1a_quartercov_uniformS2_noise0_halfInplane_rand.png}
    %     \caption*{}
    % \end{subfigure}
    % \hfill
    % \begin{subfigure}[b]{0.23\linewidth}
    %     \centering
    %     \includegraphics[height=3cm]{figures/5a1a_quartercov_uniformS2_noise0_apr.png}
    %     \caption{}\label{fig:5a1a-noise0-reconstruction-recovered}
    % \end{subfigure}
    % \hfill
    % \begin{subfigure}[b]{0.31\linewidth}
    %     \centering
    %     %\includegraphics[height=3cm]{figures/FSC_5a1a_fin_vs_init.pdf}
    %     \includegraphics[height=3cm]{figures/5a1a_quartercov_uniformS2_noise0_FSC_apr_init.pdf}
    %     \caption{}
    % \end{subfigure}
    ...
    \caption{%
        ...
        \banjac{I don't have access to the FSC plot settings}
        ...
        %\todo{Update reconstruction plots for \texttt{5a1a}}
        \banjac{Discuss updated \texttt{5a1a}} \lau{Suggestions: 1. remove artifact below b), 2. have (g), (i) and (k) be all displayed at the same size, 3. filter volumes at the resolution indicated by the FSC at 0.5 (commonly done in the field), 4. add short captions. Other comment: I'm a little bit surprised at the FSC in (j), let's discuss this evening.}
        %While orientations were recovered from noisy projections, (e) was reconstructed from noiseless projections.
        \banjac{Remove the artifact in (b). Fix the FSC plots.}
