...
\begin{figure}[t]
    ...
    The second and third columns show density maps $\widehat{\x}$ reconstructed from projections $\{ \p_i \}$, and recovered orientations $\{ \widehat{q_i} \}$~(b,e,h) or true orientations $\{ q_i \}$~(c,f,i).
        ...
        \mdeff{Could we have larger text in the FSC figures?}
    }
\end{figure}
...
\begin{figure}[t]
    ...
    \caption{%
        ...
        \mdeff{Shall we show the densities reconstructed from random angles? If not, we could show our reconstructed densities in Figure 11. The ground-truths are shown in Figure 6.}
    }
\end{figure}
