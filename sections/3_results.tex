...
\begin{figure}
    ...
    \begin{minipage}[b]{0.45\linewidth}
        \begin{subfigure}[b]{\linewidth}
            ...
            %\includegraphics[width=0.23\linewidth]{figures/de_5a1a_last.pdf}
            \caption{Loss converged on \texttt{5j0n} (left) and \texttt{5a1a} (right).\vspace{0.8em}}%
...
\begin{figure}[t]
    \begin{subfigure}[b]{0.15\linewidth}
        \centering
        \includegraphics[height=2cm]{figures/5j0n_fullcvg_uniformS2_noise0_gt.png}
        \caption{}\label{fig:5j0n-noise0-reconstruction-true}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.15\linewidth}
        \centering
        \includegraphics[height=2cm]{figures/5j0n_fullcvg_uniformS2_noise0_rand.png}
        \caption{}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.15\linewidth}
        \centering
        \includegraphics[height=2cm]{figures/5j0n_fullcvg_uniformS2_noise0_apr.png}
        \caption{}\label{fig:5j0n-noise0-reconstruction-recovered}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.15\linewidth}
        \centering
        \includegraphics[height=2cm]{figures/5j0n_fullcvg_uniformS2_noise16_apr.png}
    ...
    \begin{subfigure}[b]{0.30\linewidth}
        ...
        \includegraphics[height=2cm]{figures/5j0n_fullcvg_uniformS2_FSC_apr_init_customFSC.pdf}
        \caption{}
    \end{subfigure}
    ...
    \begin{subfigure}[b]{0.15\linewidth}
        \centering
        \includegraphics[height=2cm]{figures/5a1a_quartercov_uniformS2_noise0_gt.png}
        \caption{}\label{fig:5a1a-noise0-reconstruction-true}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.15\linewidth}
        \centering
        \includegraphics[height=2cm]{figures/5a1a_quartercov_uniformS2_noise0_rand.png}
        \caption{}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.15\linewidth}
        ...
        \includegraphics[height=2cm]{figures/5a1a_quartercov_uniformS2_noise0_apr.png}
    ...
    \end{subfigure}
    \caption{%
        Density maps $\widehat{\x}$ reconstructed from ground-truth (a,f), random (b,g), and recovered (c,d,h) orientations.
        Orientations were recovered from noiseless projections of \texttt{5j0n} (c), noisy projections of \texttt{5j0n} (d), or noiseless projections of \texttt{5a1a} (h).
        The Fourier shell correlations (e,i) show the resolutions of the densities reconstructed from recovered orientations (w.r.t.\ ground-truth densities, shown in \figref{density-map:5j0n:ground-truth},d).
        \lau{Suggestions: 3. filter volumes at the resolution indicated by the FSC at 0.5 (commonly done in the field), 4. add short captions.}
        %While orientations were recovered from noisy projections, (e) was reconstructed from noiseless projections.
        %\mdeff{Suggestion to gain space: all \texttt{5j0n} reconstructions on the first line, and group (d) and (f) as a single plot with two colors and a legend? That would also make the FSC difference easier to see. Shall we even show (e)? It's barely different from (c).}
        \todo{Consistency: same color in both FSC figures for noiseless, resolution text with the same color as the line.}
        \mdeff{If easy (and it works), could we do noisy \texttt{5a1a} for completeness? Would need to update Figure 10 too.}
        \todo{Legend: ``noiseless projections ($\sigma=0$)'' and ``noisy projections ($\sigma=16$)'' in both FSC figures.}
        \todo{Make FSC figures wider with larger text.}
        \mdeff{Shall we show the FSC of the reconstructions from ground-truth and random orientations? Could be easier to understand: four reconstructions corresponding to four FSC plots. Or are they really boring?}
