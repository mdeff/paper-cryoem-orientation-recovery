...
Finally, we ran the whole machinery on a synthetic dataset to assess how well orientations could be recovered from distances estimated by the trained SNN (\secref{results:orientation-recovery:reconstruction}).
