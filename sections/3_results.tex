...
%\todo{Make clearer. Are there enough details?}\banjac{I don't think I can go more specific.}
...
\begin{figure}[t]
    ...
    \caption{%
        ...
        \banjac{The orange and green boxes contain the $L_{DE}$ \eqnref{distance-learning} on validation and training sets respectively.}
...
\todo{Quantify the resolution of the reconstructions.}\todo{Working on this with Laurene. Have some problems uploading density maps on the website.}
