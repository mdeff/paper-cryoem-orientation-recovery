...
The convolution operator $\mathbf{C}_{\boldsymbol\varphi}: \R^M \to \R^M$ models the microscope contrast transfer function (CTF) with parameters $\boldsymbol\varphi = (d_1, d_2, \alpha_\mathrm{ast})$, where $d_1$ is the defocus-major, $d_2$ is the defocus-minor, and $\alpha_\mathrm{ast}$ is the angle of astigmatism.
...
\mdeff{Should we move that (the equation and text below it) to the intro? It goes well with \figref{imaging-geometry} and would help us when we talk about rotations in \secref{method:orientation-representation}.}
\mdeff{We shall decompose $\mathbf{P}_{\bth_i}$ into a rotation $R(\bth_i)$ and an integration.}
...
\begin{figure}
    ...
    \caption{
        ...
        \todo{Figure y-label: "Orientation recovery loss".}
...
\begin{figure}
    ...
    \\
    \begin{subfigure}[b]{0.45\textwidth}
        \includegraphics[height=5.7cm]{images/5j0n_perfect_angle_ralignment_before}
        \caption{Orientation recovery error without alignment.}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.5\textwidth}
    \centering
        \includegraphics[height=5.7cm]{images/5j0n_perfect_angle_ralignment_after}
...
\begin{figure}[ht!]
    ...
    \begin{subfigure}[t]{0.45\textwidth}
        \includegraphics[height=7.5cm]{images/eucl_notrobust_5j0n}
        \caption{Asymmetric protein (\texttt{5j0n}).}
    \end{subfigure} \quad \quad
    \begin{subfigure}[t]{0.5\textwidth}
        \includegraphics[height=7.5cm]{images/eucl_notrobust_5a1a}
        \caption{Symmetric protein (\texttt{5a1a}).}
    \end{subfigure}
    \caption{
...
\begin{figure}
    \centering
    \begin{subfigure}[t]{0.45\textwidth}
        \includegraphics[height=5.5cm]{images/de_5j0n}
        \caption{Asymmetric protein (\texttt{5j0n}).}
        \label{fig:losses-siamese-assym}
    \end{subfigure} \quad \quad
    \begin{subfigure}[t]{0.5\textwidth}
        \includegraphics[height=5.5cm]{images/de_5a1a}
        \caption{Symmetric protein (\texttt{5a1a}).}
    ...
    \caption{
        ...
        \todo{Figure: same scale on y-axis, like 0 and 0.5. A limit of 0.5 is sufficient and will better show the difference between the two losses (= overfitting).}
...
\begin{figure}
    \centering
        \includegraphics[height=8cm]{images/de_noises_nums}
        \caption{%
            ...
            \mdeff{Great figure again!}
            \todo{y-label: "Distance learning loss"}
        }\label{fig:distance-estimation-vary-projection-noise}
\end{figure}

\begin{figure}
    \centering
        \includegraphics[height=8cm]{images/de_translation_nums}
        \caption{
...
\begin{figure}
    \centering
    \begin{subfigure}[b]{0.45\textwidth}
        \includegraphics[height=5.5cm]{images/5j0n_noise0_angle_recovery}
        \caption{Recovery loss, noiseless projections $\mathbf{Px}$.}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.5\textwidth}
    \centering
        \includegraphics[height=5.5cm]{images/5j0n_noise16_angle_recovery}
    ...
    \centering
        ...
        \includegraphics[height=5.7cm]{images/5j0n_noise0_angle_alignment_after}
    ...
    \centering
        ...
        \includegraphics[height=5.7cm]{images/5j0n_noise16_angle_alignment_after}
    ...
    \caption{%
        ...
        \todo{Figure y-label: "Orientation recovery loss".}
        \mdeff{I merged three figures to make the comparison easier. I removed the orientation recovery error before alignment as it's meaningless. We can show its importance only once in \figref{5j0n-aa-loss-perfect-distances}.}
...
\begin{figure}
    ...
    \caption{
        ...
        \mdeff{I again merged figures for easier comparison. I also kept the layout consistent (noiseless on the left).}
...
\begin{figure}
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[height=5.5cm]{images/5a1a_noise0_angle_recovery}
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        ...
        \includegraphics[height=5.5cm]{images/5a1a_noise0_angle_alignment_after.png}
    ...
    \caption{
        ...
        \mdeff{I merged and removed the error before alignment for the same reasons.}
        \todo{Figure (a) y-label: "Orientation recovery loss".}
        \todo{Figures should have the same aspect ratio to align nicely.}
