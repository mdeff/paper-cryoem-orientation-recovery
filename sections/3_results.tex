...
\begin{figure}[t]
    ...
    \begin{subfigure}[b]{0.22\linewidth}
        ...
        \caption{Noiseless projections of \texttt{5a1a} (quarter coverage with half plane above, no halfplane below).}%
        \label{fig:5a1a-noise0-orientation-recovery-all-quarter}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.22\linewidth}
        \centering
