...
Those will especially help when the task is more difficult, as for \textt{5a1a}.
% Recurring theme.
...
\mdeff{Shall we use ``noiseless projections'' or ``clean projections''?}
