...
\begin{figure}[t]
    ...
    \caption{%
        ...
        %\banjac{Would like it too, but I don't have anymore time to do it.}
        % \todo{Legend: ``noiseless projections ($\sigma=0$)'' and ``noisy projections ($\sigma=16$)'' in both FSC figures.}
        % \todo{Make FSC figures wider with larger text.}\banjac{done}
