...
\begin{figure}[t]
    ...
    \begin{subfigure}[b]{0.31\linewidth}
        ...
        \includegraphics[height=3cm]{figures/5j0n_fullcvg_uniformS2_FSC_apr_init_customFSC.pdf}
        \caption{}
    \end{subfigure}
    ...
    \caption{%
        Density maps $\widehat{\x}$ reconstructed from ground-truth (a,e), random (b,f), and recovered (c,g) orientations.
        The Fourier shell correlations (d,h) show the resolutions of the densities reconstructed from recovered orientations (w.r.t.\ ground-truth densities, shown in \figref{density-map:5j0n:ground-truth},d).
        ...
        \banjac{Only Noisy16 is shown for \texttt{5j0n}}
