...
\lau{For maximal efficiency, I'll work on this once we have agreed on a final version of the experiments/results.} In this work, we explored the use of distance learning between two 2D projections of the 3D protein structure for the inference of the angles at which these projections were imaged from.
