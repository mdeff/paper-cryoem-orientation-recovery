...
\begin{itemize}
    ...
    \item More data and larger/more powerful SiameseNN for better distance approximation. More data to close the overfitting gap (e.g., \texttt{5a1a}), more powerful to push $L_\text{DE}$ down.
        Data: more pairs, data augmentation from imaging model \eqnref{imaging-model}, more proteins.
\end{itemize}
Future work:
\begin{itemize}
...
\mdeff{Shall we emphasize that we're not pursuing the work, but hope someone will?}
