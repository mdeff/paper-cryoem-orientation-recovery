...
Finally, our method was able to recover orientations with an error of \lau{$0.19$ to $0.25$ radians ($11$ to $14\degree$)} from noiseless and noisy projections---leading to an initial \todo{volume/reconstruction} with a resolution of \lau{$???$} (\secref{results:orientation-recovery:reconstruction}).
