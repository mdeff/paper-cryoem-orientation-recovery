...
In this regard, an interesting aspect of our method is that the twin networks within the SiameseNN intrinsically predict the \textit{relationship} between projections, allowing the SiameseNN as a whole to abstract the particular volume.
