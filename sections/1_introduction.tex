...
\begin{figure}
    ...
    \begin{subfigure}[t]{0.45\linewidth}
        \centering
        \includegraphics[height=7cm]{intuition-method}
        \caption{}
...
\caption{%
    ...
    (a) Geometry of the imaging model $\p$ defined with equation \eqnref{projection-eqn}.
    ...
    The direction $(\theta_2, \theta_1) \in [0,\pi[ \, \times \, [0,2\pi]$ (parameterizing the sphere $\mathbb{S}^2$) and the in-plane rotation $\theta_3 \in [0,2\pi[$ (parameterizing the circle $\mathbb{S}^1$) forms the \textit{orientation} $\bth = (\theta_3, \theta_2, \theta_1)$.
