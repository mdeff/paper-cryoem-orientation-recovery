...
On the other hand, \todo{why ML can help (good forward model for training, plenty of data, well-studied modality (images) with known high-performing NN architectures).}
In this work, we present a new approach to estimate the unknown orientations in SPA directly from the acquired dataset of projections, hence bypassing some of the aforementioned limitations.
