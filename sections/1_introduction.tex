...
\begin{figure}
    ...
    \begin{subfigure}[b]{0.48\linewidth}
        \centering
        \includegraphics[width=0.7\linewidth]{geomProj3D}
        \caption{%
    ...
    \begin{subfigure}[b]{0.48\linewidth}
        \centering
        \includegraphics[width=0.7\linewidth]{intuition-method}
        \caption{%
            Single-particle cryo-EM produces $P \approx 10^5$ projections taken from unknown orientations: $\{(\p_i, q_i)\}_{i=1}^P$.
    ...
    \end{subfigure}
    \caption{Projections, orientations, and distances.}
\end{figure}
