...
\mdeff{Jelena, were the projections sampled from full or half (but not quarter) coverage here?}
...
\begin{figure}
    \begin{minipage}[b]{0.4\linewidth}
        \centering
        \includegraphics[width=\linewidth]{figures/5j0n_perfect_angle_recovery}
        \caption{%
    ...
    \begin{minipage}[b]{0.55\linewidth}
        \centering
        \includegraphics[width=\linewidth]{figures/geo_eucl_mlp_distance_metric.pdf}
        \caption{%
