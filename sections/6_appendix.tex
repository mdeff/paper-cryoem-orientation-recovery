...
\newpage
\section{Example of 3D proteins and 2D projections}\label{apx:protein-atomic-model-density-map-projections}
...
\begin{figure}[ht!]
    \begin{minipage}[t]{0.29\linewidth}
        ...
        \includegraphics[height=2.7cm]{figures/5a1a_quartercov_uniformS2_perfect_ar_aa}
        \caption{%
...
%        \hfill
        ...
        \begin{subfigure}[t]{0.49\linewidth}
            ...
            \includegraphics[height=2.7cm]{figures/BeforeAA.pdf}
        ...
        \begin{subfigure}[t]{0.49\linewidth}
            ...
            \includegraphics[height=2.7cm]{figures/AfterAA.pdf}
