...
\figref{5j0n-aa-loss-perfect-distances} shows how~\eqnref{orientation-recovery-error} perfectly aligned the recovered and true orientations---leading to $E_\text{OR} = 0$.
