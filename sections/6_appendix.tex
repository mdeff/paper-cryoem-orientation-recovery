...
\begin{figure}[ht!]
    ...
    \end{subfigure}
    \caption{%
        Full pipeline on the orientations with uniform sampling of Euler angles from full 2-sphere coverage (up) and orientations with uniform distribution of orientations from full 2-sphere coverage (down).\todo{*up* is used in the main content, remove here}
