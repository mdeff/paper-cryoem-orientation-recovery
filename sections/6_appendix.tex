...
Comparing Figures~\ref{fig:nonuniform:recovery} with~\ref{fig:5j0n-noise0-orientation-recovery} and~\ref{fig:nonuniform:reconstruction} with~\ref{fig:5j0n-reconstruction-fsc} shows that the recovered orientations and the reconstructed density are barely affected by a non-uniform sampling of orientations---a condition that might happen in real cryo-EM acquisitions.
