...
\figref{geo-eucl-mlp} compares the use of the three distances. \lau{\textit{Clarify:} The MLP  fails to ... given its flexibility, it needs a lot of data to properly train.} The Euclidean distance yields better results, but the cosine distance is ultimately the best performer of all: $L_\text{DE}$ is the lowest, which makes $d_p$ a better estimator of $d_q$.
