...
\begin{figure}[t]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \includegraphics[width=\textwidth]{images/fig_perfectdistances_loss-symmetric.png}
        \caption{} 
    \end{subfigure} \quad 
    \begin{subfigure}[b]{0.48\textwidth}
    \centering 
        \includegraphics[width=0.8\textwidth]{images/fig-perfectdistances-coverage-symmetric.png}
        \caption{} 
    \end{subfigure}
...
\begin{figure}
    \centering
    \includegraphics[width=0.75\textwidth]{images/fig-robustness-asymmetric.png}
