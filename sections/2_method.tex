...
We however set $d_f$ as the cosine distance to facilitate the learning of a distance that respects the elliptic geometry of $\mathbb{S}^3$ (empirically evaluated in \apxref{siamese:feature-distance}).
