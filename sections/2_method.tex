...
\begin{figure}[ht!]
    ...
    \begin{minipage}[b]{0.8\linewidth}
        ...
        Different direction constrains in \apxref{orientation-constraints}.
        \todo{Seems a bit inappropriate to put these images in the methods without explaining the optimization settings. What do you think should they stay here or be moved somewhere else?}}
