...
\begin{figure}
    ...
    \caption{%
        ...
        We propose to parameterize $\widehat{d_p}$ as a SNN, trained on a synthetic dataset of projections with associated orientation.
...
The distance $d_p$ is parameterized as the Siamese neural network (SNN)~\cite{chopra2005learning}
\begin{equation*}
