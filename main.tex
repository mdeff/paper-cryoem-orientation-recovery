...
\begin{abstract}
    ...
    Our approach consists of two steps\footnote{Our code is available at \url{https://github.com/JelenaBanjac/protein-reconstruction}.}: (i) the estimation of distances between pairs of projections, and (ii) the recovery of the orientation of each projection from these distances.
