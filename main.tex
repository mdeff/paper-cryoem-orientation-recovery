...
%(through stochastic gradient descent) an objective function by
    ...
    While not yet up to state-of-the-art method, we present the road map and preliminary results of a novel method that promises robustness to perturbation in the projections as well as the quality of the recovered orientations that strongly depends on the quality of estimated distances.
